<template>
  <b-card :header="caption">
    ...
    <nav>
      ...
      <!--<b-pagination-nav :link-gen="linkGen" :total-rows="getRowCount(items)"  v-model="currentPage"/>-->
      <!--<b-pagination-nav  :link-gen="linkGen" :per-page="perPage" v-model="currentPage" prev-text="Prev" next-text="Next" hide-goto-end-buttons/>-->
      <!--<el-pagination-->
        <!--@current-change ="linkGen"-->
