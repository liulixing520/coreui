    ...
    <div class="animated fadeIn">
          <b-row class="align-items-center" style="padding-bottom: 1.0rem;">
            <b-col cols="4" sm="4" md="2" class="mb-3 mb-xl-0">
              <b-button block pressed variant="outline-dark" aria-pressed="true">新闻订单(10)</b-button>
            </b-col>
            <b-col cols="4" sm="4" md="2"  class="mb-3 mb-xl-0">
              <b-button block variant="outline-dark">自媒体</b-button>
            </b-col>
            <b-col cols="4" sm="4" md="2" class="mb-3 mb-xl-0">
              <b-button block variant="outline-dark">微信公众号</b-button>
            </b-col>
          </b-row>
